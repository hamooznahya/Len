...
import com.google.gson.annotations.SerializedName
 ...
 class SettingsAndTranslations(


    @SerializedName("editPersonalDetailsName")
    var editPersonalDetailsName: String,
...
//
    ...
    var byCreatingAnAccountYouAgree: String,


    @SerializedName("trackingWillAutomaticallyDisabledAfterYourViolationEnded")
    var trackingWillAutomaticallyDisabledAfterYourViolationEnded: String,


    @SerializedName("fillOutAndGetStarted")
    var fillOutAndGetStarted: String,
    ...
    var preferNotToSay: String,


    @SerializedName("addNewRelative")
    var addNewRelative: String,
    ...
    var termsAndPrivacyAgreementMessage: String,


    @SerializedName("mustBeAtLeast6Characters")
    var mustBeAtLeast6Characters: String,
